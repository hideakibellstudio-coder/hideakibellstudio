...
const I18n = (() => {
  ...
  const DICTIONARY = {
    [LANGUAGES.EN]: {
      ...
      studio_feed_prev_hint: "Latest updates",
      studio_feed_next_hint: "The very beginning",
      ...
      studio_support_options_title: "Ways to support",
      studio_support_options_empty: "Payment options are being set up. Your support message still helps this project move forward.",
    ...
    [LANGUAGES.PT]: {
      ...
      studio_feed_prev_hint: "Atualizações",
      studio_feed_next_hint: "Início de tudo",
      ...
      studio_support_options_title: "Formas de apoiar",
      studio_support_options_empty: "As opções de pagamento estão sendo configuradas. Sua mensagem de apoio já ajuda este projeto a seguir em frente.",
